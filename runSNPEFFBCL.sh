...
for vcfFile in /seq/vgb/swofford/R01/convertingToSKLInput/testVCFs/BCL/*.mergedSNPINDEL.vcf
do
    database=Canis_lupus_familiaris
    odir=/seq/vgb/swofford/R01/convertingToSKLInput/testVCFs/BCL/snpEFFrerun
