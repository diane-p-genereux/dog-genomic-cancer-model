Canis_lupus_familiaris#!/bin/bash                                                                                                                                                                                                                  
...
for vcfFile in /seq/vgb/cancer_r01/canine_melanoma_hitte/*.vcf
do
    database=Canis_lupus_familiaris
    odir=/seq/vgb/swofford/R01/convertingToSKLInput/testVCFs/MELANOMA/
