...
for vcfFile in /seq/vgb/swofford/R01/convertingToSKLInput/testVCFs/germline/*.vcf
do
    database=Canis_lupus_familiaris
    odir=/seq/vgb/swofford/R01/convertingToSKLInput/testVCFs/germline/snpEFFrun
